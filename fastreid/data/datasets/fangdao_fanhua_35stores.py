...
def get_all_sample(val_dataname, query_cam):
    ...
    data_name_set_2 = ['100000007', '100000305', '100000318', '100002002', '100002006', '100002009', '100009001', '100022002', '100075009', '100076003', 
    '100079002', '100079033', '123000081', '123000096']
    data_name_set_2 = ['{}_{}'.format(x,date) for x in data_name_set_2]

    data_name_set += data_name_set_2

    date_3 = '2020-07-16'
    data_name_set_3 = ['100000008', '100000526', '100003002', '100008003', '100033001', '100079008']
    data_name_set_3 = ['{}_{}'.format(x,date_3) for x in data_name_set_3]
    data_name_set_3 += ['100001107_2020-07-23']
    ...
    samples_train_2 = get_samples(data_root_val, remove_path, info_path, data_name_set_3, path_anno)
    samples_train.update(samples_train_2)
...
class Fangdao_Fanhua_35stores(ImageDataset):
    dataset_dir = ''
    def __init__(self, root='datasets', **kwargs):
        ...
        super(Fangdao_Fanhua_35stores, self).__init__(train, query, gallery, **kwargs)
