...
class Fangdao_74stores(ImageDataset):
    dataset_dir = ''
    ...
    def __init__(self, root='datasets', **kwargs):
        ...
        super(Fangdao_74stores, self).__init__(train, query, gallery, **kwargs)

    def split_samples(self, data_dir, val_dataname, query_cam):
        data_dir_train_extra = '/data/ywu/fangdao/samples_attributes_5/client'
        # extra_set = ['100000027_2020-02-16', '100000159_2020-02-16', '100001071_2020-02-16', '100001093_2020-02-16']
        # extra_set = ['101000183_2020-05-08','101000157_2020-05-08','397000003_2020-05-08','123000022_2020-05-08','101000088_2020-05-08','101000199_2020-05-08','111000018_2020-05-08','123000189_2020-05-08',
            # '123000137_2020-05-08','110000136_2020-05-08','123000130_2020-05-08',
            # '100001011_2020-05-08','101000187_2020-05-08','101000188_2020-05-08','123000290_2020-05-08','123000008_2020-05-08','100000538_2020-05-08','123000275_2020-05-08','110000130_2020-05-08','123000317_2020-05-08']
        # extra_set = ['100051002_2020-05-08',
        #             '101000059_2020-05-08',
        #             '111000010_2020-05-08',
        #             '111000027_2020-05-08',
        #             '101001026_2020-05-08',
        #             '101001011_2020-05-08',
        #             '100000085_2020-05-08']
        ...
        img_paths_extra = glob.glob(osp.join(data_dir_train_extra, '*.jpg'))

        print('img_paths_extra: ', len(img_paths_extra))
        # img_paths_extra = [x for x in img_paths_extra if x.split('/')[-1].split('#')[0] in extra_set]
        # print('img_paths_extra: ', len(img_paths_extra))
        # exit()
        img_paths += img_paths_extra
